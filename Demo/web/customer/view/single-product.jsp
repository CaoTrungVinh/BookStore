                        ...
                        <div class="single-product-image-inner">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane <%=i==1?"active":""%>" id="<%=img.getString("id")%>">
                                    <a class="venobox" href="/public/customer/img/shop/<%= img.getString("img")%>" data-gall="gallery" title="">
                            ...
                            <ul class="product-tabs" role="tablist">
                                <%
                                    ...
                                    while (img.next()) {
                                        i++;
                                %>
                                <li role="presentation" class="<%=i==1?"active":""%>"><a href="#<%=img.getString("id")%>" aria-controls="one" role="tab" data-toggle="tab">
                                    <img height="160" width="150" src="/public/customer/img/shop/<%= img.getString("img")%>" alt="">
                                </a></li>
                                <% } %>
...
<%--                                <li role="presentation"><a href="#three" aria-controls="three" role="tab" data-toggle="tab"><img src="img/single-product/3.jpg" alt=""></a></li>--%>
                    ...
                    <div class="col-md-6 col-sm-5">
                        <div class="single-product-details ">
                            ...
                            author.first();
                            %>
                            <p><label style="padding-right: 5px">Tác giả:    </label><%= author.getString("name")%></p>
                            <div class="availability">
<%--                                <span>In stock</span>--%>
                            </div>

                            <div class="single-product-price">
                                <h2><%= Util.formatCurrency(book.getString("price"))%></h2>
                            </div>
                            ...
                            <div class="add-to-wishlist">
                                <a class="wish-btn" href="cart.jsp">
                ...
                <div style="padding-top: 50px" class="row">
                    ...
                    <h3>Giới thiệu sách: </h3>
                        <div class="white-panel">
                            <p><%= book.getString("description")%></p>
                        </div>
                                ...
                                <div class="product-wrapper">
                                    ...
                                    <div class="product-description">
                                        <div class="functional-buttons">
                                            <a onclick="addToCard(<%=listBook.getInt("id")%>)"
                                               title="Add to Cart">
